...
export const getFirstStep = (steps: Array<Step>, group: string = steps[0].group): Step => Object
  .values(steps)
  .reduce((a, b) => (!a || a.group !== group || a.order > b.order ? b : a), null);

export const getLastStep = (steps: Array<Step>, group: string = steps[0].group): Step => Object
  .values(steps)
  .reduce((a, b) => (!a || a.group !== group || a.order < b.order ? b : a), null);
...
export const getPrevStep = (steps: Array<Step>,
  step: ?Step,
  group: string = steps[0].group): number => Object
  .values(steps)
